...
#url <- "https://www.cenace.gob.mx/Docs/01_MECP/CatalogoNodosP/2024/Cata%CC%81logo%20NodosP%20Sistema%20Ele%CC%81ctrico%20Nacional%20(v2024-01-24)%20.xlsx"

#response <- GET(url, config = config(ssl_verifypeer = 0L, ssl_verifyhost = 0L))
...
for( Nodo in Datos_Nodos$CLAVE ){
  ...
  #respuesta <- GET(url, config = config(ssl_verifypeer = 0L, ssl_verifyhost = 0L))
